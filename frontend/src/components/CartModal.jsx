                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-1 gap-3">
                                    {paymentMethods.map((method) => (
                                        <Card
                                            key={method.id}
                                            className={`cursor-pointer transition-all duration-200 hover:shadow-md ${paymentMethod === method.id
                                        ...
                                        >
                                            <CardContent className="p-4">
                                                <div className="flex items-center space-x-3">
                                                    <div className={`p-2 rounded-lg flex-shrink-0 ${paymentMethod === method.id
                                                        ? 'bg-blue-100 dark:bg-blue-500/20'
                                                        : isDarkMode ? 'bg-gray-700' : 'bg-gray-100'
                                                        }`}>
                                                        <method.icon className={`w-4 h-4 ${paymentMethod === method.id
