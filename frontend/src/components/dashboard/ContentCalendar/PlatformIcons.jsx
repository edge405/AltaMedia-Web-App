...
export default function PlatformIcons({ platforms, size = 'sm' }) {
    const sizeClasses = {
        xs: 'w-3 h-3',
        sm: 'w-4 h-4',
        md: 'w-5 h-5',
    ...
    const selectedPlatforms = Object.entries(platforms || {}).filter(([_, selected]) => selected);
    ...
    return (
        <div className="flex items-center gap-1">
            {selectedPlatforms.map(([platform, _]) => {
                ...
                return (
                    <div
                        key={platform}
                        className={`${sizeClasses[size]} ${platformData.color} flex-shrink-0`}
