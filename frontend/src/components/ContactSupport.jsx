                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    {contactMethods.map((method) => (
                                        <Card
                                            key={method.id}
                                            className={`cursor-pointer transition-all duration-200 hover:shadow-lg ${isDarkMode ? 'bg-gray-800 border-gray-700 hover:bg-gray-700' : 'hover:bg-gray-50'
                                                }`}
                                            onClick={() => handleContactMethod(method)}
                                        >
                                            <CardContent className="p-4">
                                                <div className="text-center space-y-3">
                                                    <div className={`inline-flex p-3 rounded-full ${isDarkMode ? 'bg-blue-500/20' : 'bg-blue-100'
                                                        }`}>
                                                    ...
                                                    <div className="flex items-center justify-center">
                                                        <Badge className={`${method.available
                        ...
                        <div className="space-y-6 animate-fade-in">
                            ...
                            <Card className={`${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-gray-50'}`}>
                                <CardContent className="p-6 space-y-4">
                                    <div className="flex items-start space-x-3">
                                        <MapPin className={`w-5 h-5 mt-1 flex-shrink-0 ${isDarkMode ? 'text-gray-400' : 'text-gray-600'
                                            }`} />
                                        <div>
                                            <h4 className={`font-semibold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
                                                {businessInfo.name}
                                    ...
                                    <div className="flex items-start space-x-3">
                                        <Clock className={`w-5 h-5 mt-1 flex-shrink-0 ${isDarkMode ? 'text-gray-400' : 'text-gray-600'
                                            }`} />
                                        <div>
                                            <h4 className={`font-semibold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
                                                Business Hours
                                    ...
                                    <div className="flex items-start space-x-3">
                                        <Phone className={`w-5 h-5 mt-1 flex-shrink-0 ${isDarkMode ? 'text-gray-400' : 'text-gray-600'
                                            }`} />
                                        <div>
                                            <h4 className={`font-semibold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
                                                Phone
                                    ...
                                    <div className="flex items-start space-x-3">
                                        <Mail className={`w-5 h-5 mt-1 flex-shrink-0 ${isDarkMode ? 'text-gray-400' : 'text-gray-600'
                                            }`} />
                                        <div>
                                            <h4 className={`font-semibold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
                                                Email
                                    ...
                                    <div className="flex items-start space-x-3">
                                        <ExternalLink className={`w-5 h-5 mt-1 flex-shrink-0 ${isDarkMode ? 'text-gray-400' : 'text-gray-600'
                                            }`} />
                                        <div>
                                            <h4 className={`font-semibold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
                                                Website
