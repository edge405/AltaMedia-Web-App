...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 04, 2025 at 10:14 AM
...
CREATE TABLE `brandkit_questionnaire_forms` (
  ...
  `has_social_media` varchar(10) DEFAULT NULL,
  `social_media_platforms` longtext DEFAULT NULL,
  ...
  `desired_social_media_platforms` longtext DEFAULT NULL,
  ...
  `collaboration_references` text DEFAULT NULL,
  `current_step` int(11) DEFAULT 1,
  `progress_percentage` int(11) DEFAULT 0,
  `is_completed` tinyint(1) DEFAULT 0,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `offering_type` varchar(50) DEFAULT NULL COMMENT 'Primary offering type (product, service, both, etc.)',
  `product_industry` varchar(100) DEFAULT NULL COMMENT 'Industry or category of the product/service',
  `product_industry_other` varchar(255) DEFAULT NULL COMMENT 'Custom industry specification when "other" is selected',
  `product_type` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'Type of product/service offerings',
  `product_features` text DEFAULT NULL COMMENT 'Key features and benefits of the product/service',
  `product_pricing` varchar(50) DEFAULT NULL COMMENT 'Pricing tier of the product/service',
  `product_stage` varchar(50) DEFAULT NULL COMMENT 'Current stage of the product/service',
  `product_materials` text DEFAULT NULL COMMENT 'Existing product photos or materials'
...
INSERT INTO `brandkit_questionnaire_forms` (`id`, `user_id`, `brand_name`, `brand_description`, `primary_customers`, `desired_emotion`, `unfair_advantage`, `customer_miss`, `problem_solved`, `competitors`, `competitor_likes`, `competitor_dislikes`, `brand_differentiation`, `brand_kit_use`, `templates`, `internal_assets`, `file_formats`, `cultural_adaptation`, `brand_voice`, `admired_brands`, `inspiration_brand`, `communication_perception`, `brand_logo`, `logo_redesign`, `has_existing_colors`, `existing_colors`, `preferred_colors`, `colors_to_avoid`, `imagery_style`, `font_types`, `font_styles`, `legal_considerations`, `source_files`, `required_formats`, `reference_materials`, `inspiration_brands`, `brand_vibe`, `has_social_media`, `social_media_platforms`, `facebook_url`, `instagram_url`, `twitter_url`, `linkedin_url`, `tiktok_url`, `youtube_url`, `pinterest_url`, `snapchat_username`, `other_social_media_urls`, `want_to_create_social_media`, `desired_social_media_platforms`, `brand_words`, `brand_avoid_words`, `tagline`, `mission`, `vision`, `core_values`, `has_web_page`, `web_page_upload`, `want_web_page`, `main_contact`, `additional_info`, `collaboration_references`, `current_step`, `progress_percentage`, `is_completed`, `created_at`, `updated_at`, `offering_type`, `product_industry`, `product_industry_other`, `product_type`, `product_features`, `product_pricing`, `product_stage`, `product_materials`) VALUES
('232f2786-c4d8-4d2e-8381-9d9b68b51f65', 8, 'Water Bottle', '\"Water Bottle is a mindful, eco-conscious brand that delivers innovative hydration solutions, with a commitment to sustainability and quality, ensuring our customers enjoy a superior, refreshing experience while making a positive impact on the planet.\"', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'yes', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'no', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'yes', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'no', NULL, NULL, 'sample', 'sample', '[\"uploads\\\\forms\\\\form_1756890257167_q8tdw5lu8_Acer_Wallpaper_01_3840x2400.jpg\"]', 1, 11, 1, '2025-08-28 04:32:59', '2025-09-04 05:09:23', 'product', 'food-beverage', NULL, '[\"Physical Product\",\"Digital Product\"]', 'They get hydrated fast and have more benefits rather than natural water', 'budget', 'launch', NULL),
('48e4a226-10dd-4628-9659-6a3373c7a953', 12, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 9, 100, 1, '2025-09-03 05:09:18', '2025-09-03 05:09:34', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('8e88405d-f07e-4a7f-81c0-aa232433d396', 5, 'Water Bottle', '\"Water Bottle: Your stylish partner in hydration, empowering sustainable living with high-quality, innovative solutions that blend environmental consciousness with unparalleled elegance.\"', NULL, NULL, NULL, NULL, 'Water Bottle, as a lifestyle brand, addresses a significant problem that resonates with many of today\'s consumers - the need for sustainable, high-quality hydration solutions that don\'t compromise on style. In an era where single-use plastics are contributing significantly to environmental degradation, there\'s a growing demand for durable, eco-friendly alternatives.\n\nCustomers are increasingly aware and concerned about the environmental impact of their purchasing decisions. However, they often find it challenging to find products that align with their sustainability values without sacrificing quality or aesthetics. This is the pain point that Water Bottle effectively addresses.\n\nBy offering durable and stylish hydration solutions, Water Bottle allows customers to make environmentally-conscious choices that don\'t compromise on quality or personal style. The brand\'s products are not only practical and eco-friendly, but they also exude a simplicity and elegance that appeals to the modern consumer.\n\nSo, in essence, Water Bottle solves the problem of finding a hydration solution that is sustainable, high-quality, and stylish - a combination that today\'s discerning consumers are actively seeking but often struggle to find.', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '[\"Sustainable\",\"Stylish\",\"Quality\"]', '[\"Cheap\",\"Disposable\",\"Harmful\"]', '\"Water Bottle: Sip Sustainability, Style, and Quality.\"', '\"Water Bottle exists to champion eco-conscious living through our innovative and stylish hydration solutions. We are committed to nurturing a sustainable world, one sip at a time, by empowering individuals to make environmentally responsible choices without compromising on quality, aesthetics, or their personal style. Our mission is to redefine hydration by intertwining sustainability, quality, and style, fostering a healthier planet and a more conscious community.\"', '\"Embracing a future where hydration and sustainability merge seamlessly, Water Bottle envisions a world where quality, style, and environmental consciousness are not mutually exclusive. We aspire to lead the revolution towards eco-friendly lifestyle choices, fostering a global community that values sustainable living without compromising on elegance or quality. In our envisioned future, every sip taken from a Water Bottle is a testament to a consumer\'s commitment to preserving our planet, promoting a lifestyle that is as stylish as it is sustainable.\"', '[\"Sustainability\",\"Quality\",\"Innovation\",\"Style\",\"Conscious Living\"]', NULL, NULL, NULL, NULL, NULL, NULL, 2, 22, 1, '2025-08-27 05:40:36', '2025-08-31 16:39:40', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('d582ecde-de0c-4624-babd-aba05d8fdd30', 9, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 9, 100, 1, '2025-08-26 03:34:21', '2025-08-26 03:34:37', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
('998b6c23-41d2-4717-b458-2024b1245f73', 8, 'organization', NULL, NULL, NULL, NULL, NULL, NULL, '[\"Social Media Calendar\",\"Ad Creatives\",\"Caption Writing + Hashtags\",\"Video Editing\",\"Graphics Design\",\"Platform Setup/Optimization\",\"Performance Reports\"]', 'within-1-month', NULL, NULL, '[]', 4, 100, 0, NULL, '2025-08-28 12:33:17', '2025-09-03 17:09:32'),
...
ALTER TABLE `brandkit_questionnaire_forms`
  ...
  ADD KEY `idx_offering_type` (`offering_type`),
  ADD KEY `idx_product_industry` (`product_industry`),
  ADD KEY `idx_product_pricing` (`product_pricing`),
  ADD KEY `idx_product_stage` (`product_stage`);
